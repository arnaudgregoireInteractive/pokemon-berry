...
export default class DialogGenerator{
    ...
    static createTextBox(scene, x, y, actions){
        var textBox = scene.rexUI.add.textBox({
                ...
                background: scene.rexUI.add.roundRectangle(0, 0, 2, 2, 2, COLOR_PRIMARY)
        ...
        textBox
            .setInteractive({cursor:`url(data:image/png;base64,) 14 0, pointer`})
